...
import com.jyzn.wifi.service.account.AccountManager;
import com.jyzn.wifi.service.account.CaptchaAuthenticationFilter;
...
//        List<Group> grouplist = user.getGroupsList();
        User user = SystemVariableUtils.getSessionVariable().getUser();
        ...
        for (Group gr : grouplist) {
            if (StringUtils.contains(A, gr.getName())) {
                ret = "shop/index";
                break;
            }
        }
