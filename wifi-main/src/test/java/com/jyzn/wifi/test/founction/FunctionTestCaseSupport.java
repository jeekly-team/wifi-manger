package com.jyzn.wifi.test.founction;
...
import com.jyzn.wifi.test.LaunchJetty;
...
public class FunctionTestCaseSupport {
	...
	public static final String URL="http://localhost:8080/biwifi";
	...
	public static void uninstall() {
		...
		s.click(By.xpath("//a[@href='/biwifi/logout']"));
	}
