...
--WifiUser
INSERT INTO BIWIFI."PUBLIC".WIFIUSER (ID, "NAME") 
	VALUES ('202881e437d47b250137d481b6920001', '18691525183');
INSERT INTO BIWIFI."PUBLIC".WIFIUSER (ID, "NAME") 
	VALUES ('202881e437d47b250137d481b6920002', 'zyt');
INSERT INTO BIWIFI."PUBLIC".WIFIUSER (ID, "NAME") 
	VALUES ('202881e437d47b250137d481b6920003', 'jeekly');
INSERT INTO BIWIFI."PUBLIC".WIFIUSER (ID, "NAME") 
	VALUES ('ff80808146f76ade0146f784d2f00005', '15232219841');

--ValidateLog
insert into validatelog values('SJDK3849CKMS3849DJCK2039ZMSK0001',current_date,'001','phmsg','202881e437d47b250137d481b6920002',);
insert into validatelog values('SJDK3849CKMS3849DJCK2039ZMSK0002',current_date,'002','wx','202881e437d47b250137d481b6920002',);
insert into validatelog values('SJDK3849CKMS3849DJCK2039ZMSK0003',current_date,'003','blog','202881e437d47b250137d481b6920003',);
insert into validatelog values('SJDK3849CKMS3849DJCK2039ZMSK0004',current_date,'001','wx','202881e437d47b250137d481b6920001',);
INSERT INTO BIWIFI."PUBLIC".VALIDATELOG (ID, DT, SID, "TYPE", WIFIUSER_ID) 
	VALUES ('ff80808146f76ade0146f76d02c30000', '2014-07-02 22:14:14.642', 'test', 'phmsg', '202881e437d47b250137d481b6920001');
INSERT INTO BIWIFI."PUBLIC".VALIDATELOG (ID, DT, SID, "TYPE", WIFIUSER_ID) 
	VALUES ('ff80808146f76ade0146f77102c30002', '2014-07-02 22:18:37.122', 'test', 'phmsg', '202881e437d47b250137d481b6920001');
INSERT INTO BIWIFI."PUBLIC".VALIDATELOG (ID, DT, SID, "TYPE", WIFIUSER_ID) 
	VALUES ('ff80808146f76ade0146f77ba4a50003', '2014-07-02 22:30:13.925', 'test', 'phmsg', '202881e437d47b250137d481b6920001');
INSERT INTO BIWIFI."PUBLIC".VALIDATELOG (ID, DT, SID, "TYPE", WIFIUSER_ID) 
	VALUES ('ff80808146f76ade0146f77d1bb30004', '2014-07-02 22:31:49.939', 'test', 'phmsg', '202881e437d47b250137d481b6920001');
INSERT INTO BIWIFI."PUBLIC".VALIDATELOG (ID, DT, SID, "TYPE", WIFIUSER_ID) 
	VALUES ('ff80808146f76ade0146f784d6d40006', '2014-07-02 22:40:16.17', 'test', 'phmsg', 'ff80808146f76ade0146f784d2f00005');
INSERT INTO BIWIFI."PUBLIC".VALIDATELOG (ID, DT, SID, "TYPE", WIFIUSER_ID) 
	VALUES ('ff80808146f76ade0146f78a06340008', '2014-07-02 22:45:56.404', 'test', 'phmsg', '202881e437d47b250137d481b6920001');
INSERT INTO BIWIFI."PUBLIC".VALIDATELOG (ID, DT, SID, "TYPE", WIFIUSER_ID) 
	VALUES ('ff80808146f76ade0146f78ab77c0009', '2014-07-02 22:46:41.788', 'test', 'phmsg', 'ff80808146f76ade0146f784d2f00005');
